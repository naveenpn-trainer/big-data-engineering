...
echo 4. Resolve ports are not available error
...
if "%choice%"=="1" (
    ...
    echo "Execute commands in Administrator mode: net stop winnat"
	echo "Execute commands in Administrator mode: net start winnat"
) else (
